...
function Footer() {
    return (
        <>
            <div className='bg-himaptika p-4 text-white'>
                ...
                <div className='lg:w-[80%] mx-auto my-3'>
                    <div className='flex lg:flex-row flex-col gap-5'>
                        ...
                        <div className='lg:basis-[50%]'>
                            <div className='flex gap-2 items-center'>
                                <h1 className='font-semibold text-xl'>Tetap Terhubung dengan Kami</h1>
                    ...
                    <div className='text-center text-sm mt-5'>
                        <h1 className='font-bold'>COPYRIGHT @2023 HIMAPTIKA FKIP ULM</h1>
                        <h1 className='text-sm'>Dikembangkan oleh Divisi Media Kreatif</h1>
                    </div>
                </div>
            </div>
        </>
